<?php
  ...
  return array(
	...
	'event notifications disabled for object type' => 'Email notifications are disabled for events in the notification settings.',
	...
	'check to include sub ws' => 'Check this to include sub workspaces in the url',
  	...
  	'week number x' => 'Week {0}',
		...
		'invalid event repeat times' => 'Invalid event repeat times',
		'invalid event repeat jump' => 'Invalid event repeat jump',
		'Attendees' => 'Attendees',
		'Organizer' => 'Organizer',
		...
		'event not responded' => 'Not responded',
		'event not confirmed' => 'Not confirmed',
		'event not declined' => 'Not declined',
		...
		'When' => 'When',
		'organizer' => 'Organizer',
		'invitation from feng_evx calendar' => 'Invitation from {0} Calendar.',
		'this event has been updated' => 'This event has been updated.',
		'this event has been cancelled' => 'This event has been cancelled.',

		'select people to invite to this event' => 'Select people to invite to this event',
		'select people to invite to this event help' => 'You can type in the input to filter the list, also you can create new contacts by using the \'Add Contact\' option that appears in the contacts dropdown list.',
  ); // array
?>