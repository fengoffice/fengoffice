locale = 'en_us';
addLangs({
	'add a new custom member in': 'Add a new {0}',
    'all': 'all',
    'All': 'All',
    'total': 'Total',
    'to date': 'Until',
    ...
    'select': 'Select',
    'select plural': 'Select {0}',
    'select singular': 'Select a {0}',
    'search placeholder': 'Search {0}...',
    'clear': 'Clear',
    ...
    'tasks date range filter info': 'Shows tasks where the selected date field falls within the selected range.',
    'tasks date filter info': 'Shows tasks where either the Start Date or Due Date falls within the selected range.',
    ...
    'quick add time': 'Quick add time',
    'quick start clock': 'Quick start clock',
    ...
    'confirm delete with keyword': 'Type \"{0}\" to confirm',
    'delete confirmation keyword mismatch': 'Type \"{0}\" exactly to confirm the deletion.',
    ...
    'show closed subtasks with status filter': 'Show subtasks outside status filter',
	...
	'predefined property' : 'Predefined property',
	'dimension' : 'Dimension',
    'show all tasks' : 'Show all',
    'object' : 'Object',
	...
	'empty' : 'Empty',
    'error edit task': 'Error editing task',
    // Column Manager
    'columns'                : 'Columns',
    'manage columns'         : 'Manage columns',
    'manage columns tooltip' : 'Show, hide and reorder columns',
    'available columns' : 'Available',
    'visible columns'   : 'Visible',
    'no visible columns': 'No visible columns',
    'drag to reorder'   : 'Drag to reorder',
    'select columns hint': 'Select columns from the left to add them',
    'select at least one column': 'You must select at least one column',
    'column always visible': 'This column is always visible',
    'apply'             : 'Apply',
    'hide'              : 'Hide',
    'remove all'        : 'Remove all',
    'do not show tasks' : 'Do not show tasks',
