<?php return array(
	...
	'user ws config option name show_emails_as_conversations' => '会話としてメールを表示',
	...
	'user ws config option name autodetect_time_zone' => 'タイムゾーンを自動認識',
	...
	'user ws config option name classify_mail_with_conversation' => '会話のあるメールの指定',
	'user ws config option name displayed events amount' => '表示イベント数',
	'user ws config option desc displayed events amount' => '月表示で表示させる一日のイベント数',
	...
	'edit member' => 'メンバーの編集',
	'reminder_email' => 'メール',
	'user ws config option name attach_to_notification' => '通知にドキュメントを添付',
