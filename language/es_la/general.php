<?php return array(
	...
	'task template category' => 'Categoría',
	'task templates uncategorized' => 'Sin categoría',
	'manage task template categories' => 'Administrar categorías de plantillas',
	'new task template category' => 'Nueva categoría',
	'task template category sort order' => 'Orden',
	'task template category name required' => 'El nombre de la categoría es obligatorio',
	'success add task template category' => 'Categoría agregada correctamente',
	'success edit task template categories' => 'Categorías actualizadas correctamente',
	'success delete task template category' => 'Categoría eliminada correctamente',
	'cannot delete task template category in use' => 'No se puede eliminar la categoría porque hay plantillas de tareas asignadas a ella',
	'confirm delete task template category' => '¿Eliminar esta categoría?',
	'no task template categories' => 'Aún no hay categorías definidas',
	'task template categories unavailable' => 'Las categorías de plantillas no están disponibles. Ejecute la actualización de base de datos del plugin advanced_core.',
	...
	'success add member' => '{0} \'{1}\' fue agregado exitosamente',
	'success edit member' => '{0} \'{1}\' fue editado exitosamente',
	'tab' => 'Pestaña',
	...
	'drag columns hint' => 'Arrastre el ícono ☰ para reordenar columnas',
	'no columns match' => 'Ninguna columna coincide con la búsqueda',
	'save error' => 'No se pudieron guardar los cambios. Intente nuevamente.',
	'evx projects display lines' => 'Mostrar',
	'evx projects general settings' => 'Configuración general',
	'evx projects widget settings' => 'Configuración del widget',
	'evx projects sort by' => 'Ordenar por',
	'evx projects sort direction' => 'Dirección de ordenamiento',
	'evx projects sorted by' => 'Ordenado por',
	'evx projects ascending' => 'Ascendente',
	'evx projects descending' => 'Descendente',

	// tasks widget (core) — exclusive strings
	'tasks widget title' => 'Tareas',
	'tasks project column' => 'Proyecto',
	'tasks quick actions' => 'Acciones rápidas',
	'tasks quick actions hint' => 'menú al pasar el mouse',
	'add subtask' => 'Agregar subtarea',
	'mark as started' => 'Marcar como iniciada',
	'add time entries' => 'Agregar registro de tiempo',
	'due this week' => 'Vencen esta semana',
	'assigned to me' => 'Asignadas a mí',

	// activity_feed widget (core) — exclusive strings
	'no activity to display' => 'No hay actividad para mostrar',
  ...
  'invalid_cp_url_value' => 'Valor invalido en un campo URL',
	...
	'active_context_info' => 'Detalles de los filtros seleccionados',
	...
	'format' => 'Formato',
		...
		'not classified in x' => 'No clasificado en {0}',
		'individual contacts' => 'Contactos individuales',
		'companies and groups' => 'Empresas y grupos',
		'type filters' => 'Filtros de tipo',
		'contacts / companies' => 'Contactos / Empresas',
		'filter contact cp dropdown by' => 'Esta opción le permite definir si solo desea seleccionar personas, empresas o ambas en esta propiedad.',
	...
	'permissions defined per role' => 'Aqui se puede definir los permisos por defectos para cada tipo de rol del sistema.',
	'Default permissions by object type' => 'Permisos por defecto por tipo de objeto',
	'Default permissions for role' => 'Permisos por defecto para el rol',
	'Default role permissions saved' => 'Los permisos por defecto para el rol se han guardado exitosamente.',

	'discount' => 'Descuento',
	'discounts' => 'Descuentos',
	'config option name match_subtask_percent_completed' => 'Hacer coincidir el porcentaje completado de las subtareas con el porcentaje completado establecido manualmente en la tarea padre',
	...
	'select columns hint' => 'Seleccione columnas de la izquierda para agregarlas',
	'apply' => 'Aplicar',

	'unknown file type' => 'Tipo de archivo desconocido',

	// File type friendly names (keyed by lowercase extension)
	'file type friendly name zip' => 'Archivo comprimido (ZIP)',
	'file type friendly name rar' => 'Archivo comprimido (RAR)',
	'file type friendly name bz' => 'Archivo comprimido (BZ)',
	'file type friendly name bz2' => 'Archivo comprimido (BZ2)',
	'file type friendly name gz' => 'Archivo comprimido (GZ)',
	'file type friendly name ace' => 'Archivo comprimido (ACE)',
	...
	'file type friendly name doc' => 'Documento de Microsoft Word',
	'file type friendly name docx' => 'Documento de Microsoft Word',
	'file type friendly name xls' => 'Hoja de cálculo de Microsoft Excel',
	'file type friendly name xlsx' => 'Hoja de cálculo de Microsoft Excel',
	'file type friendly name xlsb' => 'Hoja de cálculo binaria de Microsoft Excel',
	'file type friendly name ppt' => 'Presentación de Microsoft PowerPoint',
	'file type friendly name pptx' => 'Presentación de Microsoft PowerPoint',
	'file type friendly name csv' => 'Archivo de valores separados por comas',
	'file type friendly name gif' => 'Imagen GIF',
	'file type friendly name jpg' => 'Imagen JPEG',
	'file type friendly name jpeg' => 'Imagen JPEG',
	'file type friendly name png' => 'Imagen PNG',
	'file type friendly name svg' => 'Gráfico vectorial (SVG)',
	'file type friendly name psd' => 'Documento de Adobe Photoshop',
	'file type friendly name pdf' => 'Archivo PDF',
	'file type friendly name txt' => 'Archivo de texto',
	'file type friendly name html' => 'Archivo HTML',
	'file type friendly name odt' => 'Documento de texto OpenDocument',
	'file type friendly name fodt' => 'Documento de texto OpenDocument',
	'file type friendly name ics' => 'Archivo iCalendar',
	'file type friendly name webfile' => 'Archivo web',
	'file type friendly name slim' => 'Archivo de presentación Slim',
	'file type friendly name mov' => 'Película QuickTime',
	'file type friendly name qt' => 'Película QuickTime',
	'file type friendly name avi' => 'Video AVI',
	'file type friendly name mpeg' => 'Video MPEG',
	'file type friendly name mpg' => 'Video MPEG',
	'file type friendly name vob' => 'Archivo de objeto de video DVD',
	'file type friendly name rm' => 'Archivo RealMedia',
	'file type friendly name swf' => 'Película Shockwave Flash',
);
