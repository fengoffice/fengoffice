<?php return array(
	...
	'milestone due date required' => 'Fecha límite del hito requerida',
	...
	'value cannot be empty' => 'El valor de {0} no puede estar vacío',
	'report name required' => 'El nombre del reporte es requerido',
	'report name already exists' => 'Ya existe un reporte con este nombre',
    ...
    'ck upload not authorized' => 'No autorizado para cargar archivos.',
    'ck upload no file' => 'No se ha seleccionado ningún archivo para cargar.',
    'ck upload invalid type' => 'Tipo de archivo no permitido.',
    'ck upload failed to move' => 'No se pudo mover el archivo cargado.',
	'error edit task' => 'Ha ocurrido un error al editar la tarea. Por favor, inténtelo nuevamente.',
); ?>
