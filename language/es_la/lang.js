...
addLangs({
  ...
  'select': 'Seleccionar',
  'select plural': 'Seleccionar {0}',
  'select singular': 'Seleccionar un {0}',
  'search placeholder': 'Buscar {0}...',
  'clear': 'Limpiar',
  'n selected': '{0} seleccionados',
  'read': 'Leídos',
  ...
  'tasks date range filter info': 'Muestra las tareas donde el campo de fecha seleccionado cae dentro del rango elegido.',
  'tasks date filter info': 'Muestra las tareas donde la Fecha de Inicio o la Fecha de Vencimiento cae dentro del rango elegido.',
  ...
  'cp boolean not specified': 'Sin especificar',
...
'all contact types' : 'Todos los tipos de contacto',
'companies and groups' : 'Empresas y grupos',
'predefined property' : 'Propiedad predefinida',
'dimension' : 'Dimensión',
'export_excel' : 'Exportar a Excel',
'exporting to excel' : 'Exportando a Excel',
'downloading file' : 'Descargando archivo',
'error exporting to excel' : 'Error al exportar a Excel',
'empty' : 'Vacio',
'error edit task' : 'Error al editar la tarea',
'columns'                : 'Columnas',
