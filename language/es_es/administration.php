<?php return array(
	...
	'template edit missing objects list' => 'No se pudo guardar la plantilla porque el formulario no incluyó la lista de tareas. Recargue la página, espere a que aparezcan todas las tareas e intente nuevamente.',
	'template edit stale form' => 'No se pudo guardar la plantilla porque fue modificada desde que abrió este formulario. Recargue la página e intente nuevamente.',
...
{0}',
	...
	'user config option name tasksShowClosedSubtasksWithStatusFilter' => 'Mostrar subtareas fuera del filtro de estado',
	'user config option desc tasksShowClosedSubtasksWithStatusFilter' => 'Cuando hay un filtro de estado activo, muestra las subtareas que no coinciden con él (por ejemplo, subtareas cerradas bajo tareas abiertas al filtrar por Abierto/Pendiente).',
	'user config option name tasksOrderSubtasksWithFilterCriteria' => 'Ordenar subtareas con el criterio de orden seleccionado en el listado de tareas',
	'user config option desc tasksOrderSubtasksWithFilterCriteria' => 'Si está en Sí, las subtareas anidadas se ordenan con el mismo criterio de Ordenar por seleccionado en el listado de tareas. Si está en No, se ordenan por Nombre.',
	...
	'cp boolean allow not specified' => 'Permitir "Sin especificar"',
    ...
    'user config option desc automatic_calculation_time'=>'Cuando Usted modifica el tiempo trabajo (o pausado), ¿qué prefiere que haga el sistema?',
    'user config option name automatic_calculation_start_time'=>'Comportamiento al modificar las fechas',
    'user config option desc automatic_calculation_start_time'=>'Cuando Usted modifica la fecha de inicio o de fin de un registro de horas trabajadas, ¿qué prefiere que haga el sistema?',
