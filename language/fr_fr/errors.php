<?php return array(
	...
	'invalid upload size' => 'Taille d\'image incorrecte . La taille maxi est de {0}',
	...
	'failed to load company website' => 'Le chargement du site a échoué. La société n\'a pas été trouvée\\n',
	...
	'invalid login data' => 'La connexion a échoué. Vérifiez vos paramètres de connexion et réessayez.',
	...
	'file revision file_id required' => 'La révision doit être liée à un fichier',
	...
	'maximum disk space reached' => 'Votre limite disque est atteinte. Supprimer quelques objets avant d\'en ajouter de nouveau, ou contacter le support pour autoriser plus d\'utilisateurs.',
	...
	'error invalid recipients' => 'Certaines adresses courriel ont un problème "{0}": {1}',
	'error cannot assign task to user' => 'La tâche {0} ne peut pas être assignée à {1}',
	'no mailAccount error' => 'Vous ne pouvez pas envoyer de message, car vous n\'avez pas de compte courriel.',
	'content too long not loaded' => 'Le message joint ne peut être affiché, mais sera envoyé avec ce message.',
	...
	'upload error msg UPLOAD_ERR_INI_SIZE' => 'La taille du fichier téléchargé dépasse la taille maximale de téléchargement ({0}).',
	'upload error msg UPLOAD_ERR_FORM_SIZE' => 'La taille du fichier téléchargé dépasse la taille maximale de téléchargement ({0}).',
	'upload error msg UPLOAD_ERR_PARTIAL' => 'Le fichier téléchargé a été partiellement téléchargé.',
	'upload error msg UPLOAD_ERR_NO_FILE' => 'Aucun fichier n\'a pu être téléchargé.',
	'upload error msg UPLOAD_ERR_NO_TMP_DIR' => 'Aucun fichier n\'a pu être téléchargé, dossier temporaire manquant.',
	'upload error msg UPLOAD_ERR_CANT_WRITE' => 'Impossible d\'écrire le fichier sur le disque.',
	'upload error msg UPLOAD_ERR_EXTENSION' => 'Une extension PHP a arrêté le téléchargement du fichier.',
	'failed to authenticate email account' => 'Échec de l\'authentification du compte de messagerie',
	'failed to authenticate email account desc' => 'Impossible d\'authentifier le compte "{0}". Pour envoyer des notifications, veuillez vous assurer que le nom d\'utilisateur et le mot de passe du compte sont corrects.',
	'you cant add member without security permissions' => 'Vous ne pouvez pas ajouter {0} sans spécifier où il se trouve car vous ne pouvez pas gérer les permissions. Veuillez sélectionner l\'emplacement de {0} pour que les permissions puissent être héritées.',
	'token external key value required' => 'La clé est requise',
