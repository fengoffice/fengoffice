...
return array(
  ...
  'checked out by' => 'Bejelentette',
	...
	'user date bold' => '<a class="internalLink" href="{0}" title="{3} adatainak megtekintése">{1}</a> {2} napon',
	'user date today at' => '<a class="internalLink" href="{0}" title="{3} adatainak megtekintése">{1}</a> ma {2} időpontban',
	'user date today at bold'  => '<a class="internalLink" href="{0}" title="{3} adatainak megtekintése">{1}</a> ma {2} időpontban',
