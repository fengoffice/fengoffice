...
{0}',
	...
	'config option name notify_myself_too' => 'Inclui-me nas notificaões automáticas',
	'config option desc notify_myself_too' => 'Se habilitado, as notificações automáticas incluirão ao meu usuário (só disponível para documentos)',
