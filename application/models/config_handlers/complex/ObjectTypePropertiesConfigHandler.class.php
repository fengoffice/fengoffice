...
class ObjectTypePropertiesConfigHandler extends ConfigHandler {
    ...
    function render($control_name) {
		...
		$include_role = array_var($options, 'include_role', false);
        ...
        $object_type_properties = $object_type->getObjectTypeProperties($include_common_cols, true, true, $include_role);
