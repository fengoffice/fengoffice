            ...
            <div class="coInputMainBlock">
                ...
                <div id="<?php echo $genid ?>tabs" class="edit-form-tabs">
					...
					<?php 
						...
						$tmp_task = ProjectTasks::createTmpTaskCopyFromTemplateTask($task);
					...
					?>
                        ...
                        <div class="main-custom-properties-div">
							<div class="custom-properties-container two-columns">
                                <div class="custom-properties-column custom-properties-left">
                                    <div class="property-group">
                                        <div class="property-group-header"><?php echo lang('details') ?></div>
										<div class="property-group-body">
                                            ...
                                            <div class="dataBlock" id='<?php echo $genid ?>add_task_time_div'>
                                                ...
                                                <div class="time-estimate">
                                                    ...
                                                    <?php echo text_field("task[time_estimate_hours]", $hours, array('id' => 'ogTasksPanelATHours')) ?>
                                            ...
                                            <?php if ((array_var($task_data, 'time_estimate') == 0) || (ProjectTasks::checkTaskInTemplate($task, 'fixed fee tasks'))) { ?>
                                                <div class="dataBlock">
                                                    ...
                                                    <?php echo input_field('task[percent_completed]', array_var($task_data, 'percent_completed', 0), array('class' => 'short', 'type' => 'number', 'min' => '0', 'max' => '100')) ?>
                                                    <div class="clear"></div>
                                                </div>
                                            <?php } ?>
                                            ...
                                            <div class="dataBlock">
                                                ...
                                                <div class="linked-objects-container">
                                                    <a class="link" id="<?php echo $genid ?>parent_before" href="#" onclick="og.pickParentTemplateTask(this, '<?php echo $genid ?>', '<?php echo $task->getId() ?>', '<?php echo $template_id ?>')">
                                                        <i class="icon-circle-plus"></i> 
                                                        <?php echo lang('set parent task') ?>
                                                    </a>
                                                        ...
                                                        if ($parentTask instanceof ProjectTask || $parentTask instanceof TemplateTask) { ?>
                                                            <div class="selected-object-wrapper og-add-template-object">
                                                                ...
                                                                <div class="object-badge">
                                                                    ...
                                                                    <span><?php echo clean($parentTask->getTitle()) ?></span>
                                                                    <a href="#" onclick="og.removeParentTask(this.parentNode.parentNode)" class="object-remove-btn" title="<?php echo lang('remove') ?>">
                                            ...
                                            <?php if (config_option('use tasks dependencies')) { ?>
                                                <div class="dataBlock">
                                                    <label><?php echo lang('previous task') ?>:</label>
                                                    <?php
                                                    if (!$task->isNew())
                                                    ...
                                                    ?>
                                                    <div class="linked-objects-container">
                                                        <a class="link" id="<?php echo $genid ?>previous_before" href="#" onclick="og.pickPreviousTemplateTask(this, '<?php echo $genid ?>', '<?php echo $task->getId() ?>','<?php echo $template_id ?>')">
                                                            <i class="icon-circle-plus"></i> <?php echo lang('add previous task') ?>
                                                        </a>

                                                        <div class="selected-object-wrapper">
                                ...
                                <div class="custom-properties-column custom-properties-right">
                                    <div class="property-group">
                                        <div class="property-group-header"><?php echo lang('related to') ?></div>
										<div class="property-group-body">
						...
						<?php } // end of override_render_properties hook ?>
                    ...
                    <div id="<?php echo $genid ?>add_task_more_details_div" class="task-data form-tab">
                        ...
                        <div class="repeat-options-div sub-section-div">
                            ...
                            ?>
                                <table border="0" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td>
                                            <div id="<?php echo $genid ?>repeat_options" style="<?php echo $hide ?>">
                                                <div>
                                                    <?php echo lang('CAL_EVERY') . " " . text_field('task[occurance_jump]', array_var($task_data, 'rjump', '1'), array('size' => '2', 'id' => $genid . 'occ_jump', 'maxlength' => '100', 'style' => 'width:25px !important')) ?>
                                                ...
                                                <table>
                                                    ...
                                                    <tr>
                                                        <td style="vertical-align:middle">
                                                            <?php echo radio_field('task[repeat_option]', $rsel3, array('id' => $genid . 'repeat_opt_until', 'value' => '3', 'style' => 'vertical-align:middle', 'onclick' => 'og.viewDays(true)')) . "&nbsp;" . lang('CAL_REPEAT_UNTIL'); ?>
                                                        </td>
                                                        <td style="padding-left:8px;">
                                                            <?php echo pick_date_widget2('task[repeat_end]', $rend, $genid, 99); ?>
                                                        </td>
                                                    </tr>
                                                </table>
                                                <script type="text/javascript">
                        ...
                        <div class="subtasks-div sub-section-div">
                            ...
                            <div id="<?php echo $genid ?>add_task_subtasks_div">
                                ...
                                <div class="add-subtask-container d-flex flex-wrap align-items-center gap-2">
                                    ...
                                    <a href="#" class="link-ico ico-undo" onclick="ogTasks.undoRemoveSubtasks('<?php echo $genid ?>')" style="display:none;" id="<?php echo $genid ?>undo_remove"><?php echo lang('undo remove subtasks') ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <?php
                $new_button_text = $task->isNew() ? (array_var($task_data, 'is_template', false) ? lang('save template') : lang('add task list')) : lang('save changes');
...
<script>
    ...
    var current_dimension_members_json = member_selector.get_selected_context('<?php echo $genid ?>');
    ...
    if (typeof og.buildTaskFormSubscriberUids !== 'function') {
        og.buildTaskFormSubscriberUids = function(genid, assigned_to) {
            ...
            if (og.config.default_subscriber_assigned_to) {
                if (assigned_to > 0) ids[assigned_to] = true;
    ...
    og.redrawAssignedToSelectBox = function(genid, value) {
        ...
        var record = combo ? combo.findRecord(combo.valueField, assigned_user) : null;
        if (record) {
    ...
    og.onAssignToComboSelectTempTask = function(combo, selected, idx) {
        ...
        var ctx = Ext.util.JSON.encode(member_selector.get_selected_context('<?php echo $genid ?>'));
        og.render_tasks_form_subscribers(ctx);
    }

    og.render_tasks_form_subscribers = function(dimension_members_json) {
        var combo = Ext.getCmp('<?php echo $genid ?>taskFormAssignedToCombo');
        var assigned_to = combo ? combo.getValue() : 0;
	...
	og.reload_task_form_selectors = function(is_new, render_add_subscribers) {
		...
		if (!is_new) {
			var dimension_members_json = member_selector.get_selected_context('<?php echo $genid ?>');
		} else {
    ...
    og.addParentTask = function(before, obj) {
        var container = before.parentNode; // .linked-objects-container
        var count = container ? container.getElementsByTagName('input').length : 0;
        ...
        div.innerHTML =
            ...
            '<div class="object-badge">' +
                '<i class="icon-list-todo"></i><span>' + og.clean(obj.name) + '</span>' +
                '<a href="#" onclick="og.removeParentTask(this.parentNode.parentNode)" class="object-remove-btn" title="' + lang('remove') + '"><i class="icon-circle-x"></i></a>'+
            '</div>';
        var bef = document.getElementById('<?php echo $genid ?>parent_before');
    ...
    og.removeParentTask = function(div) {
        ...
        if (container) container.removeChild(div);
        var bef = document.getElementById('<?php echo $genid ?>parent_before');
        var label = document.getElementById('no-task-selected<?php echo $genid ?>');
    ...
    $(document).ready(function() {
        ...
        setTimeout(function() {
            ...
            $("#<?php echo $genid ?>tabs").css({
                'min-width': w + 'px'
            });
            $("#<?php echo $genid ?>tabs").parent().css({
                'overflow-x': 'auto'
            });
        }, 100);
